...
const House = ({house}) => {
  ...
  return (
    <div className='bg-white shadow-1 p-5 rounded-lg rounded-tl-[90px] w-full max-w-[352px] mx-auto cursor-pointer hover:shadow-2xl transition mt-4'>
      <img className='mb-8' src={image} alt="property-image"/>
      ...
      <div className='flex gap-x-4 my-4'>
        <div className='flex items-center text-gray-600 g-1  '>
