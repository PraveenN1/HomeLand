...
const PropertyDetails = () => {
  ...
  const handleResponse = () => {
    ...
    axios
      .post(`https://home-land-flax.vercel.app/property/${data.id}`, data)
      .then((response) => {
      ...
      .catch((error) => {
        console.error("Error submitting response:", error); // Log the error object
        toast.error("Error Submitting response", {
          position: "top-right",
        });
      });
        ...
        <div className="flex flex-col items-start gap-8 lg:flex-row ">
          ...
          <div className="flex-1 bg-slate-200 w-full mb-8 border border-gray-300 rounded-lg px-6 py-8 ">
            <div className="flex items-center gap-x-4 mb-8">
              <div className="w-20 h-20 p-1 border bg-gray-300 rounded-full">
